"""
使用脚本,需要注意6点,这很重要
1.【怕黑号的，真诚的，恳请你们不要用,不要找我，我不会赔偿你们任何损失，请你们一定不要用】
2.觉得钱少的浪费时间的,请您删除脚本即可，我怕浪费您的空间
3.代码是公开的，你可以自己二次修改，如果你是大佬，请忽略该脚本
4.如果您使用了别的作者的脚本，请勿拿我的和他人的做对比，因为我写的不好，也请您删除我的脚本，因为我的脚本会让你浪费一定的时间
5.请阅览后24小时自行删除脚本，并且请勿传播至其他群
6.你接受以上5点，用我脚本走下我链接不过分吧，不然我发出来干嘛，有亲爹不带，带你？
http://kyy.baertt.com/h5/fastAppWeb/invite/invite_ground_2.html?share_uid=1040776341&channel=c8000
