...
### 4. 购买前请留意该条例,协议版本855该版本具有封号的风险,推荐1小号先试水,token到手请勿第一时间激活，先到机器人@Mark_oool_bot 进行命令【/register】 注册完绑定你的token 命令 【/bind passtoken 收到的token值】 完成后再激活。价格35（下个月有空更新下857看看，大概可能吧）emmm 5天内随时退款,只要我看到消息秒退, (安装完后请务必使用部署命令更新下)
