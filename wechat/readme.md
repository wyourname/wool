# 请认真阅读以下使用说明与条款,否则对于使用过程中出现的任何问题概不答复 不再卖了
...
3. 部署安装完成后请周末时间联系 获取token 其他时间拒绝受理，且必须先试用3天（3天是让你琢磨怎么用，怎么部署，怎么玩，后悔药） 3天已经能让你掌握很多东西了，3天后未联系则删除token，且拒绝再次联系。不接受请绕道而行。
...
6. 阅读脚本集合【wxkele (可乐已黑号)、wxyidian(壹点联盟)、search_reward(搜搜小奖，已黑号停止维护，尚能用)、ddz(点点赚)  ddlm(叮叮联盟)、sillydog(傻狗阅读)】对于邀请，可以看公告，也可以自行寻找其他人的邀请码。我对你们的人头不感兴趣
